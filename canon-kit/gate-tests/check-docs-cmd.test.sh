...
echo "check-docs-cmd.test.sh: clean (retired set from the scratch repo's own history: committed and staged deletions red, the history valve and a never-tracked path clear, 4 cases)"
exit 0
