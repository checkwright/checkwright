...
<!-- measured: engine-substrate=shell -->
...
<!-- unmarked-claim-exempt: exhibiting the class grammar rather than asserting it -->
The engine is a shell program, shown here to document what the class recognizes.
