...
- **gate-file-coverage-closure** [cost: event/high] [surface: delegation-kit] — the missing check class behind a
...
- **design-partner-preview** [cost: event/low] [surface: installer] — a narrow external preview before
