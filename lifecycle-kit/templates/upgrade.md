...
contract owns the shape, and `--upgrade-smoke` on the gate binary `GATE_SDK_NATIVE_BIN`
names proves it mechanically where the consumer has the smoke. Exit condition: the full battery
