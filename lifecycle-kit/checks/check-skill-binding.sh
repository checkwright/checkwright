#!/usr/bin/env bash
# graph: couples=.claude/commands/*.md,lifecycle-kit/templates/stages/*.md,lifecycle-kit/templates/lead.md,lifecycle-kit/templates/release-sweep.md,lifecycle-kit/templates/upgrade.md,delegation-kit/templates/agent-execution.md dir=one valve=none tier=precommit
