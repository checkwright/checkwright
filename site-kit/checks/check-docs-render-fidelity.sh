...
# spec: site-kit/SPEC.md §check-docs-render-fidelity — every tracked docs markdown page, rendered through the pinned Pages parser, leaks no fence marker into text and promotes no code-fenced heading; a missing renderer fails closed
#
...
echo "DOCS-RENDER-FIDELITY: clean (${#pages[@]} tracked markdown page(s) under $DOCS render with no fence or heading leakage)"
exit 0
