...
echo "queue-counts.test.sh: clean (the --emit front-end resolves the arm, a configured icebox section and an emptied one each reach the rendering, and a missing file refuses; $checks checks)"
exit 0
