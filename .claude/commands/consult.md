...
- A **ruling** — an override of a business-as-usual instruction until that instruction is updated, or a reversal of a standing ruling → `TRAJECTORY.md`, naming the instruction it overrides and its discharge. Nothing else lands there. Where the instruction can be updated in this session, update it: the ruling is then discharged on landing and never enters the ledger.
