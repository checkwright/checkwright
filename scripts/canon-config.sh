...
# shellcheck disable=SC2034  # consumed by canon-kit/lib/spec.sh after sourcing
CANON_KIT_ENUM_SETS_CMD="bash gate-sdk/bin/run-gates.sh --emit enum-sets"
