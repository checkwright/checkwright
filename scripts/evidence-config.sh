...
EVIDENCE_KIT_SUITES+=(guard_tests usage_tests budget_guard_tests trend_tests demo installer_smoke consumer_smoke upgrade agents_md_smoke index_tests native_crate)
