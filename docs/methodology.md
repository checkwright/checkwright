...
The part that does the blocking (the gate battery) is a prebuilt binary, with bash
left in the library and tooling around it, over a coreutils toolchain. No gate reads a harness surface, so
