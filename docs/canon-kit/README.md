...
generated: true
---
<!-- Generated by `bash gate-sdk/bin/run-gates.sh --emit docs-mirror --write` from canon-kit/README.md. Do not edit; run the generator. -->
...
Vendor the kit beside [gate-sdk](https://github.com/checkwright/checkwright/tree/master/gate-sdk/) (required); the queue-facing gate reads the tag syntax [queue-kit](https://github.com/checkwright/checkwright/tree/master/queue-kit/) defines.
