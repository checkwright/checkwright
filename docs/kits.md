...
One page per kit. Each page orients and sequences; it owns no contract — the
contract lives in the kit that enforces it, and the page cites downward.
...
- [site-kit](site-kit/index.md) — deployment-truth governance for a repo-served
  docs site: a CNAME-host parity gate, a rendered-page fidelity gate, and a
  live-site monitor template.
