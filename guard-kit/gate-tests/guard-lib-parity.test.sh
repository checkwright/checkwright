...
# A closing ` *` that is the rule's only `*` grants the bare head too; beside another `*` it does not.
have_line "allow-match-space-star-bare"   "allow-match${T}Bash(git status)${T}Bash(git status *)${T}true"
have_line "allow-match-space-star-inner"  "allow-match${T}git status${T}git status *${T}true"
have_line "allow-match-space-star-glued"  "allow-match${T}git statusx${T}git status *${T}false"
have_line "allow-match-space-star-multi"  "allow-match${T}git status${T}git s* *${T}false"
