...
extension) gives 134 classes, where `git ls-files` gives 1989 files and
...
…" or "the trigger is …" clause. Nine rows, found by
...
- docs/site-architecture.md §Generated projections: the section intro and nine
