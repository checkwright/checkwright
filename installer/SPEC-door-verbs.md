...
- `docs/enforcement.md`, `scripts/git-hooks/pre-commit`, `docs/installer/SPEC.md` — generated projections, regenerated by the command each freshness gate prints on red (deltas 1 and 2).
