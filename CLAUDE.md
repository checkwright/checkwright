...
- **Gap disposition** — a gap you defer is costed and filed, never flagged-and-skipped; close's drain tries fix, then icebox, then promote (lifecycle-kit/SPEC.md §The committed gap inbox), and a finding about the delivery machinery itself — as it governs this tree, as opposed to the kits as product — that blocks no stage entry or push is icebox-class by default, the witness discriminator that decides the two being TRAJECTORY.md's, 2026-08-30.
