...
# A sandbox gate: its recursive corpus walk is fully covered by one couple, whose `*` crosses '/'
# and so covers corpus/top.md and corpus/sub/deep.md alike. A second walk is exempt; a third has
# an undecidable root.
