...
- `delegation-kit/README.md`, step 5's "it emits no hook JSON on either path" clause, the same claim `native/src/hook/stop_liveness.rs`'s module header carries, found by this roster's own probe and missed in the first pass (delta 1).
...
- `docs/gate-sdk/SPEC.md`, `docs/delegation-kit/SPEC.md` and `docs/delegation-kit/README.md`.
