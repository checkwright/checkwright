...
- **`docs/gate-sdk/SPEC.md`** — the generated mirror of the edited SPEC, stale
  the moment either delta lands and regenerated by its emitter rather than
  edited. (deltas 1, 2 and 3)
