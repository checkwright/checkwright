...
- [ ] **Byte-identical projections** — `docs/enforcement.md`, `docs/footprint.md` and
      `docs/value.md`'s block are unchanged by this unit; a diff in any of them is a port defect,
      never a licensed improvement.
