#!/usr/bin/env bash
# graph: couples=scripts/*.sh,gate-sdk/*.sh,lifecycle-kit/*.sh,queue-kit/*.sh,spec-kit/*.sh,guard-kit/*.sh,delegation-kit/*.sh,context-kit/*.sh,drift-kit/*.sh dir=one valve=none tier=precommit
