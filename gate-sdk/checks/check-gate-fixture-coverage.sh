#!/usr/bin/env bash
# graph: couples=scripts/gates.list,scripts/*.sh,scripts/gate-tests/*,gate-sdk/*.sh,lifecycle-kit/*.sh,queue-kit/*.sh,spec-kit/*.sh,delegation-kit/*.sh dir=one valve=none tier=precommit
