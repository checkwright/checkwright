...
- `TASK-QUEUE.md`'s `kit-roots-rel-filesystem-readers` entry: its `[cost:]` and
  its nine-site roster, both priced against a subset (delta 3). The re-pricing
  lands with the entry's move, a stage before the drain stage.
